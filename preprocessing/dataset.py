...
# 6. Split the dataset (97,5% train, 2,5% test)
...
train_file_path_tsv = os.path.join('..', 'data', 'cleaned_train_data.tsv')
train_df.to_csv(train_file_path_tsv, sep='\t', index=False)

test_df = pd.DataFrame(X_test)
test_df['domain'] = y_test
test_file_path_tsv = os.path.join('..', 'data', 'cleaned_test_data.tsv')
